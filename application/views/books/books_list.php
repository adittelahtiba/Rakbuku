    ...
    <body>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('books/read/'.$books->),'Read'); 
				echo ' | '; 
				echo anchor(site_url('books/update/'.$books->),'Update'); 
				echo ' | '; 
				echo anchor(site_url('books/delete/'.$books->),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
