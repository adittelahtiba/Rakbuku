                  ...
                  <li class="dropdown-body">
                    <ul class="dropdown-menu-list withScroll mCustomScrollbar _mCS_2" data-height="220" style="height: 220px;"><div class="mCustomScrollBox mCS-light" id="mCSB_2" style="position:relative; height:100%; overflow:hidden; max-width:100%;"><div class="mCSB_container mCS_no_scrollbar" style="position:relative; top:0;">
                      <li class="clearfix">
                        ...
                        <img src="<?php echo base_url('')?>assets/bootstrap/images/avatars/avatar3.png" alt="avatar 3">
                        </span>
                        <div class="clearfix">
                          <div>
                      ...
                      <li class="clearfix">
                        <span class="pull-left p-r-5">
                        <img src="<?php echo base_url('')?>assets/bootstrap/images/avatars/avatar4.png" alt="avatar 4">
                        </span>
                        <div class="clearfix">
                          <div>
                      ...
                      <li class="clearfix">
                        <span class="pull-left p-r-5">
                        <img src="<?php echo base_url('')?>assets/bootstrap/images/avatars/avatar5.png" alt="avatar 5">
                        </span>
                        <div class="clearfix">
                          <div>
                      ...
                      <li class="clearfix">
                        <span class="pull-left p-r-5">
                        <img src="<?php echo base_url('')?>assets/bootstrap/images/avatars/avatar6.png" alt="avatar 6">
                        </span>
                        <div class="clearfix">
                          <div>
