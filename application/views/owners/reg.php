...
<html>
    ...
    <body>
        ...
        <form action="<?php echo $action; ?>" enctype="multipart/form-data" method="post">
            ...
            <div class="form-group">
                <label for="address">Alamat lengkap <?php echo form_error('address') ?></label>
            ...
            <div class="form-group">
                <label for="varchar">Jam buka <?php echo form_error('opening_at') ?></label>
                <input type="time" class="form-control" name="opening_at" id="opening_at" placeholder="Jam buka" value="<?php echo $opening_at; ?>" />
            </div>
            <div class="form-group">
                <label for="varchar">Jam tutup <?php echo form_error('opening_at') ?></label>
                <input type="time" class="form-control" name="opening_at" id="opening_at" placeholder="Jam tutup" value="<?php echo $opening_at; ?>" />
            </div>
