		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
					...
					<li><a class="nav-item nav-link" data-toggle='tab' href="#toko">Toko</a></li>
				</ul>
				<div class="tab-content">
					...
					<div id="toko" class="tab-pane fade in">
						<div class="flex-sb-m flex-w p-b-35">
						<!-- <span class="s-text8 p-t-5 p-b-5 t-kanan col-lg-12">Showing 1–12 of 16 results</span> -->
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								...
								<div class="block2-txt p-t-20">
									<a href="product-detail.html" class="block2-name t-left dis-block s-text33 p-b-5"><?php echo $value->store_name ?></a>
									<a href="#" class="fs-12">
									...
									<hr>
									<span class="block2-price m-text6 p-r-8">
									Harga<span class="harga fs-14"><?php echo $value->price ?></span>
									</span>			
								</div>
							</div>
						</div>
