    ...
    <body>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('categories/read/'.$categories->categories_id),'Read'); 
				echo ' | '; 
				echo anchor(site_url('categories/update/'.$categories->categories_id),'Update'); 
				echo ' | '; 
				echo anchor(site_url('categories/delete/'.$categories->categories_id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
